...
def generate_bidir_traffic(trexipaddress, trexport):
    ...
    transfer.put("../trafficUtils/test-new.yaml", "/opt/cisco/trex/latest/cap2/test-new.yaml")
    transfer.close() 
...
def generate_hipriority_traffic (trexipaddress, trexport):
    ...
    transfer.put("../trafficUtils/trex_cfg.yaml", "/etc/trex_cfg.yaml")
    transfer.put("../trafficUtils/dscp_traffic1.py", "/opt/cisco/trex/latest/stl/dscp_traffic1.py")
    transfer.close() 
...
def generate_3traffic_streams (trexipaddress, trexport):
    ...
    transfer = client1.open_sftp()
    transfer.put("../trafficUtils/trex_cfg.yaml", "/etc/trex_cfg.yaml")
    transfer.put("../trafficUtils/traffic_3st.py", "/opt/cisco/trex/latest/stl/traffic_3st.py")
    transfer.close() 
